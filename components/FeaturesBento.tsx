...
export default function FeaturesBento() {
  return (
    <section id="features" className="py-16 sm:py-24 bg-[#FFFFFF] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6">
          ...
          <div className="md:col-span-8 p-5 sm:p-8 rounded-[28px] sm:rounded-3xl bg-[#F6F5F0] border border-[#DCE4D3] shadow-md hover:shadow-xl transition-all flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="mt-6 sm:mt-8 grid grid-cols-1 xs:grid-cols-3 gap-2.5 sm:gap-3">
              <div className="p-3 sm:p-3.5 rounded-2xl bg-white border border-[#DCE4D3] flex items-center gap-2.5 sm:gap-3">
          ...
          <div className="md:col-span-4 p-5 sm:p-8 rounded-[28px] sm:rounded-3xl bg-gradient-hero text-white border border-[#105e3a] shadow-md hover:shadow-xl transition-all flex flex-col justify-between">
            <div>
          ...
          <div className="md:col-span-4 p-5 sm:p-8 rounded-[28px] sm:rounded-3xl bg-[#F6F5F0] border border-[#DCE4D3] shadow-md hover:shadow-xl transition-all flex flex-col justify-between">
            <div>
