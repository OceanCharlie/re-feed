  ...
  return (
    <section id="merchant" className="py-16 sm:py-24 bg-[#FCFAF7] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Clean Bento Card */}
        <div className="max-w-5xl mx-auto app-card rounded-[28px] sm:rounded-[36px] p-5 sm:p-8 md:p-10 grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-10 items-center">
          
          {/* Left Column: Image & Info */}
          <div className="md:col-span-6 space-y-5 sm:space-y-6 text-left">
            <div className="relative h-44 sm:h-60 w-full rounded-2xl overflow-hidden bg-slate-100 border border-[#E8EDE5]">
              <Image
            ...
            <div className="space-y-2.5">
              <h3 className="text-lg sm:text-xl font-bold text-[#141A17]">
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-[#57655B]">
                <li className="flex items-start sm:items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-[#105e3a] shrink-0 mt-0.5 sm:mt-0" />
                  <span>Tanpa biaya pendaftaran atau biaya sewa bulanan</span>
                </li>
                <li className="flex items-start sm:items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-[#105e3a] shrink-0 mt-0.5 sm:mt-0" />
                  <span>Jangkau pelanggan baru di sekitar lokasi toko Anda</span>
                </li>
                <li className="flex items-start sm:items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-[#105e3a] shrink-0 mt-0.5 sm:mt-0" />
          ...
          <div className="md:col-span-6 p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-[#FCFAF7] border border-[#E8EDE5] space-y-5 sm:space-y-6 text-left">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full h-2.5 bg-[#E8EDE5] rounded-lg appearance-none cursor-pointer accent-[#105e3a]"
              />

              <div className="flex justify-between text-[10px] sm:text-[11px] text-[#57655B] font-medium">
                <span>5 Porsi</span>
                <span>25 Porsi</span>
                <span>50+ Porsi</span>
              </div>
